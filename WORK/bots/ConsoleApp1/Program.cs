        ...
        async static Task Update(ITelegramBotClient botClient, Update update, CancellationToken arg3)
        {
            ...
            if (message.Text != null)
            {
                Console.WriteLine($"{message.Chat.FirstName} | {message.Text}" +
                    $" | date {message.Date}. ");
                if (message.Text.ToLower().Contains("привет"))    //текст приходит, с любой буквы большой или маленькой, вкл в себя Contains
                {
                    ...
                    Message message2;
                    using (var stream = System.IO.File.OpenRead("C:/users/Afif07/Documents/C#/WORK/bots/ConsoleApp1/path/video-w_kfhYnln2.mp4"))  {
